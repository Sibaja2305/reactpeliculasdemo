export default function Paginacion(props: PaginacionProps) {
  ...
  const totalPaginas = Math.ceil(
    props.CantidadTotalRegistro / props.registrosPorPagina
  );
        ...
        <div className="row align-start justify-content-center">
          <div className="col-auto">
            <div className="d-flex align-items-center gap-2">
              <label className="mb-0">Registro por paginas</label>
              <select
              ...
              >
                {props.registroPorPaginaOpciones.map((opcion) => (
            ...
            <ul className="pagination justify-content-center mb-0">
              ...
              {paginas.map((pagina) => (
                <li
                  key={pagina}
                  className={`page-item ${
                    props.paginaActual === pagina ? "active" : ""
                  }`}
                >
                  <button
                    className="page-link"
              ...
              <li
                className={`page-item ${
                  props.paginaActual === totalPaginas ? "disabled" : ""
                }`}
              >
                <button
                  className="page-link"
